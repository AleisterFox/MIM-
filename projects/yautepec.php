...
<body>
    ...
    <main>
        <section id="projects" class="project">
            <h4>PROYECTOS</h4>
            <h2>Proyecto <br> <strong> Yautepec</strong></h2>
            <br>
            <br>
            <br>
            <br>
            <div id="project">
                <figure class="project__top">
                    <img src="../img/yautepec2.jpg" alt="">
                </figure>
                <div class="project__middle">
                    <figure>
                        <img src="../img/yautepec3.jpg" alt="">
                    </figure>
                    <figure>
                        <img src="../img/yautepec4.jpg" alt="">
                    </figure>
                </div>
                <figure class="project__bottom">
                    <img src="../img/yautepec5.jpg" alt="">
                </figure>
            </div>
        </section>
        <section id="back">
