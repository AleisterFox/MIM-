...
<body>
    ...
    <main>
        <section id="projects" class="project">
            <h4>PROYECTOS</h4>
            <h2>Proyecto <br> <strong> Naucalpan</strong></h2>
            <br>
            <br>
            <br>
            <br>
            <div id="project">
                <figure class="project__top">
                    <img src="../img/naucalpan2.jpg" alt="">
                </figure>
                <div class="project__middle">
                    <figure>
                        <img src="../img/naucalpan3.jpg" alt="">
                    </figure>
                    <figure>
                        <img src="../img/naucalpan4.jpg" alt="">
                    </figure>
                </div>
                <figure class="project__bottom">
                    <img src="../img/naucalpan5.jpg" alt="">
                </figure>
            </div>
        </section>
        <section id="back">
            <a href="../projects.php" class="square__button white"><i>REGRESAR A TODOS LOS PROYECTOS</i></a>
        </section>
        <section id="contact">
            <h4>CONTACTO</h4>
            <div class="container">
