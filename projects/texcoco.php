...
<body>
    ...
    <main>
        <section id="projects" class="project">
            <h4>PROYECTOS</h4>
            <h2>Proyecto <br> <strong> Texcoco</strong></h2>
            <br>
            <br>
            <br>
            <br>
            <div id="project">
                <figure class="project__top">
                    <img src="../img/texcoco2.jpg" alt="">
                </figure>
                <div class="project__middle">
                    <figure>
                        <img src="../img/texcoco3.jpg" alt="">
                    </figure>
                    <figure>
                        <img src="../img/texcoco4.jpg" alt="">
                    </figure>
                </div>
                <figure class="project__bottom">
                    <img src="../img/texcoco5.jpg" alt="">
                </figure>
            </div>
        </section>
        <section id="back">
